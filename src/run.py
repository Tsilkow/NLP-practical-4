...
if __name__ == '__main__':
    ...
    # Fro mhere on, your code should be identical independent of which
    ...
    if args.function == 'pretrain':
        ...
        tconf = trainer.TrainerConfig(max_epochs=650,
                                      ...
                                      final_tokens=200*len(pretrain_dataset)*block_size,
                                      num_workers=4)
        pretrain_trainer = trainer.Trainer(gpt_model, pretrain_dataset, None, tconf)
        ...
        with open(args.finetune_corpus_path, 'r') as f:
            finetune_dataset = dataset.NameDataset(pretrain_dataset, f.read())

        finetune_trainer = trainer.Trainer(gpt_model, finetune_dataset, None, tconf)
